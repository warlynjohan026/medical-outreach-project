    ...
    <AriaRow
      ...
      className={(state) =>
        cx(
          ...
          // Row border—using an "after" pseudo-element to avoid the border taking up space.
          '[&>td]:after:absolute [&>td]:after:inset-x-0 [&>td]:after:bottom-0 [&>td]:after:h-px [&>td]:after:w-full [&>td]:after:bg-[var(--line)] last:[&>td]:after:hidden [&>td]:focus-visible:after:opacity-0 focus-visible:[&>td]:after:opacity-0',
